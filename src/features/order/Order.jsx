...
function Order() {
  ...
  return (
    <div className='px-4 py-6 space-y-8'>
      ...
      <div className='flex flex-wrap items-center justify-between gap-2 bg-stone-300 py-5 px-6'>
      ...
      <ul className='divide-stone-300 divide-y border-t border-b'>{cart.map(item => <OrderItem item={item} key={item.id}/>)}</ul>
